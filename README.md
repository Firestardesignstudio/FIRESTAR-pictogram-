# FIRESTAR Pictogram Collection
オープンソースで公開している FIRE STAR Design Studio の  
ユーモア系・安全啓発系ピクトグラムのアートギャラリーです。

本リポジトリの画像は **非商用利用・教育利用・SNS利用は自由**、  
改変もOKですが、著作権は FIRESTAR に帰属します。
